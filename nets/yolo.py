...
from nets.CSPdarknet import C3, Conv, CSPDarknet,GSConv
...
#########################################################
   #     self.eca_block1 = eca_block(512)
   #     self.eca_block2 = eca_block(256)
   #     self.eca_block3 = eca_block(256)
   #     self.eca_block4 = eca_block(512)

   #     self.GhostModule1 = GhostModule(128,128,1)
    #    self.GhostModule2 = GhostModule(256,256,1)
    #    self.SimAM1 = SimAM()
    #    self.SimAM2 = SimAM()
  #      self.Block1 = Block(1024)
   #     self.Block2 = Block(512)
  #      self.Block3 = Block(256)
    #    self.GSConv1 = GSConv(256,256)

     #   self.GSConv2 = GSConv(128,128)

     #   self.GSConv3 = GSConv(128, 128)
    #    self.GSConv4 = GSConv(256, 256)
    ...
    def forward(self, x):
        ...
        if self.backbone_name != "cspdarknet":
          ...
          #  feat1 = self.Block1(feat1)
            feat2 = self.conv_1x1_feat2(feat2)
         #   feat2 = self.Block2(feat2)
            feat3 = self.conv_1x1_feat3(feat3)
          #  feat3 = self.Block3(feat3)
...
############################################################################
   #     y3 = self.SimAM1(P3)
    #    W1 = self.GhostModule1(P3)
     #   S1 = y3+W1

        # 80, 80, 256 -> 40, 40, 256
        P3_downsample = self.down_sample1(P3)

  #      Z3 = self.GSConv3(P3_downsample)
...
##############################################################################
  #      y4=self.SimAM2(P4)
   #     W2 = self.GhostModule2(P4)
   #     S2 = y4+W2
        # 40, 40, 512 -> 20, 20, 512
        P4_downsample = self.down_sample2(P4)

    #    Z4 = self.GSConv4(P4_downsample)
############################################################################
